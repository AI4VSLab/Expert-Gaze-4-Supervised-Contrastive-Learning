# from: https://github.com/UKPLab/sentence-transformers/blob/c5f93f70eca933c78695c5bc686ceda59651ae3b/sentence_transformers/losses/BatchAllTripletLoss.py#L8
...
class BatchAllTripletLoss(nn.Module):
    ...
    def batch_all_triplet_loss(self, labels, embeddings):
        ...
        valid_triplets = triplet_loss[triplet_loss > 1e-16] # torch.tensor(1e-16)
